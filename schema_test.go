...
func TestJsonSchemaTestSuite(t *testing.T) {
	...
	JsonSchemaTestSuiteMap := []map[string]string{
		...
		{"phase": "minNumeric validation", "test": "does not include number", "schema": "minNumeric/schema_0.json", "data": "minNumeric/data_00.json", "valid": "false"},
		{"phase": "minNumeric validation", "test": "less numbers then required", "schema": "minNumeric/schema_0.json", "data": "minNumeric/data_01.json", "valid": "false"},
		{"phase": "minNumeric validation", "test": "Include 2 numbers, not in row", "schema": "minNumeric/schema_0.json", "data": "minNumeric/data_02.json", "valid": "true", "errors": "numeric_gte"},
		{"phase": "minSpecial validation", "test": "does not include special character", "schema": "minSpecial/schema_0.json", "data": "minSpecial/data_00.json", "valid": "false"},
		{"phase": "minSpecial validation", "test": "less special characters then required", "schema": "minSpecial/schema_0.json", "data": "minSpecial/data_01.json", "valid": "false"},
		{"phase": "minSpecial validation", "test": "Include 2 characters, not in row", "schema": "minSpecial/schema_0.json", "data": "minSpecial/data_02.json", "valid": "true", "errors": "min_special"},
		{"phase": "multiCase validation", "test": "does not include upper case", "schema": "multiCase/schema_0.json", "data": "multiCase/data_00.json", "valid": "false"},
		{"phase": "multiCase validation", "test": "Have both lower and upper", "schema": "multiCase/schema_0.json", "data": "multiCase/data_01.json", "valid": "true"},
		{"phase": "multiCase validation", "test": "All upper case", "schema": "multiCase/schema_0.json", "data": "multiCase/data_02.json", "valid": "false", "errors": "multi_case"},
		{"phase": "disableSequential validation", "test": "Include only 2 characters in row", "schema": "disableSequential/schema_0.json", "data": "disableSequential/data_00.json", "valid": "true"},
		{"phase": "disableSequential validation", "test": "Have repeating abc", "schema": "disableSequential/schema_0.json", "data": "disableSequential/data_01.json", "valid": "false"},
		{"phase": "disableSequential validation", "test": "Repeat same character", "schema": "disableSequential/schema_0.json", "data": "disableSequential/data_02.json", "valid": "false"},
