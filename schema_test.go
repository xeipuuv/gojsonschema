...
func TestJsonSchemaTestSuite(t *testing.T) {
	...
	JsonSchemaTestSuiteMap := []map[string]string{
		...
		{"phase": "minSpecial validation", "test": "Include 2 characters, not in row", "schema": "minSpecial/schema_0.json", "data": "minSpecial/data_02.json", "valid": "true", "errors": "numeric_gte"},
